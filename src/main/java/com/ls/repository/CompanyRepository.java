...
public interface CompanyRepository extends JpaRepository<Company, Integer> , JpaSpecificationExecutor<Company>{
	...
	@Query(value="SELECT p.* FROM ls_company lc where lc.cityId = :cityId and (lc.oTEresourceId = :oTEresourceId or lc.name = :name)", nativeQuery=true)
	...
	@Query(value="SELECT p.* FROM ls_company lc where lc.cityId = :cityId and (lc.ganjiresourceId = :ganjiresourceId or lc.name = :name) ", nativeQuery=true)
	...
	@Query(value="SELECT p.* FROM ls_company lc where lc.cityId = :cityId and (lc.fEresourceId = :fEresourceId or lc.name = :name)", nativeQuery=true)
